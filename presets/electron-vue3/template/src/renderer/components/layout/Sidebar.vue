...
<template>
  ...
  >
    <!-- Logo area -->
    <div class="flex items-center h-[var(--titlebar-height)] px-4 flex-shrink-0">
      <transition name="fade" mode="out-in">
        <div v-if="!appStore.sidebarCollapsed" key="expanded" class="flex items-center gap-2.5 overflow-hidden">
        ...
        <div v-else key="collapsed" class="w-full flex justify-center">
